...
declare module JQueryUI {
    ...
    interface Draggable extends DraggableOptions, DraggableEvent {
    }
...
interface JQuery {
    ...
    draggable(options: JQueryUI.Draggable): JQuery;
    draggable(optionLiteral: string, optionName: string): any;
    draggable(optionLiteral: string, options: JQueryUI.Draggable): any;
    ...
    droppable(options: JQueryUI.Droppable): JQuery;
    droppable(optionLiteral: string, optionName: string): any;
    droppable(optionLiteral: string, options: JQueryUI.Droppable): any;
